        ...
        <Box>
          {selectedId ? (
            ...
            <>
              ...
              <MovieList>
                {watched?.map((movie) => (
                  <WatchedMovieItem key={movie.imdbID} movie={movie} onSelectMovie={handleSelectMovie} onCloseMovie={handleSelectMovie}  onRemoveWatchedMovie={handleRemoveWatchedMovie} />
                ))}
              </MovieList>
            </>
          )}
